...
public class MyEnvironment extends Environment {
	...
	public double[] nouvellesCoordonnees(BlobAgent agent, double pas, double[] pastDirection) {
		...
		boolean isOK = false;
		// Je dois prendre en compte les bordures. Je dï¿½cide de ne pas compliquer les
		// calculs :
		// Je mets le tout dans une boucle, et je relance l'alï¿½atoire si je suis en
		// dehors du terrain.

		if (pastDirection != null && Math.random() * 100 < 90) {
			// je maintiens ma direction prï¿½cï¿½dente, dont j'ai stockï¿½ le vecteur dans
			// pastDirection
	...
	public void setHeterogeneite(int heterogeneite) {
		...
		System.out.println(
				"la nouvelle valeur " + heterogeneite + " d'hï¿½tï¿½rogï¿½nï¿½itï¿½ a ï¿½tï¿½ prise en compte");
	}
